...
const endpointScenarios: Array<EndpointScenario> = [
	...
	},
	{
		name: 'production',
		config: {
			base_domain: 'fluxer.cameronjolly.com',
			public_scheme: 'https',
			internal_scheme: 'http',
			public_port: 443,
			internal_port: 8080,
		...
		expected: {
			api: 'https://fluxer.cameronjolly.com/api',
			api_client: 'https://fluxer.cameronjolly.com/api',
			app: 'https://fluxer.cameronjolly.com',
			gateway: 'wss://fluxer.app/gateway',
			media: 'https://fluxer.cameronjolly.com/media',
			static_cdn: 'https://fluxer.cameronjolly.com',
			admin: 'https://fluxer.cameronjolly.com/admin',
			docs: 'https://fluxer.dev',
			marketing: 'https://fluxer.cameronjolly.com/marketing',
			invite: 'https://fluxer.cameronjolly.com/invite',
			gift: 'https://fluxer.cameronjolly.com/gift',
		},
	},
	{
		name: 'staging',
	...
	},
	{
		...
		config: {
			...
			internal_scheme: 'http',
			public_port: 443,
			static_cdn_domain: 'cdn-fluxer.cameronjolly.com',
		},
		expected: {
			api: 'https://fluxer.cameronjolly.com/api',
			api_client: 'https://fluxer.cameronjolly.com/api',
			app: 'https://fluxer.cameronjolly.com',
			gateway: 'wss://fluxer.cameronjolly.com/gateway',
			media: 'https://fluxer.cameronjolly.com/media',
			static_cdn: 'https://cdn-fluxer.cameronjolly.com',
			admin: 'https://fluxer.cameronjolly.com/admin',
			docs: 'https://fluxer.dev',
			marketing: 'https://fluxer.cameronjolly.com/marketing',
			invite: 'https://fluxer.cameronjolly.com/invite',
