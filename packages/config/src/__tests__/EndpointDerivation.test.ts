...
const endpointScenarios: Array<EndpointScenario> = [
	...
	},
	{
		...
		expected: {
			...
			gateway: 'wss://web.fluxer.app/gateway',
			media: 'https://web.fluxer.app/media',
			static_cdn: 'https://web.fluxer.app',
			admin: 'https://web.fluxer.app/admin',
			docs: 'https://fluxer.dev',
			marketing: 'https://web.fluxer.app/marketing',
			invite: 'https://web.fluxer.app/invite',
			gift: 'https://web.fluxer.app/gift',
		},
	},
	{
		name: 'staging',
	...
	},
	{
		...
		config: {
			...
			internal_scheme: 'http',
			public_port: 443,
			static_cdn_domain: 'cdn-web.fluxer.app',
		},
		expected: {
			api: 'https://web.fluxer.app/api',
			api_client: 'https://web.fluxer.app/api',
			...
			gateway: 'wss://web.fluxer.app/gateway',
			media: 'https://web.fluxer.app/media',
			static_cdn: 'https://cdn-web.fluxer.app',
			admin: 'https://web.fluxer.app/admin',
			docs: 'https://fluxer.dev',
			marketing: 'https://web.fluxer.app/marketing',
			invite: 'https://web.fluxer.app/invite',
