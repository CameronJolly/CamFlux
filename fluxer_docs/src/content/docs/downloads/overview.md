...
Fluxer publishes every desktop build and every Linux package repository to one public origin, `https://web.fluxer.app`. It is a static file origin. It serves bytes and nothing else, it needs no credential, and it declares no rate limit bucket.
