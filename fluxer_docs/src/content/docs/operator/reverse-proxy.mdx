...
We are grateful to everyone supporting the project through [Fluxer Plutonium](https://fluxer.cameronjolly.com/plutonium) or [donations](https://fluxer.cameronjolly.com/donate). All of our code is free and open source on [GitHub](https://github.com/fluxerapp/fluxer). The Operator Pass is coming, and adds a direct line to the team for help and feedback.
:::
