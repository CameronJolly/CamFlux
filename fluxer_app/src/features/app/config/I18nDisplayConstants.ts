...
export const LINK_PREVIEW_EXAMPLE_URL = 'https://web.fluxer.app';
...
export const DESKTOP_DOWNLOAD_URL =
	Config.PUBLIC_RELEASE_CHANNEL === 'canary' ? 'https://web.fluxer.app/download' : 'https://web.fluxer.app/download';
